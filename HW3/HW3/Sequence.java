public class Sequence extends Element{
  ...
  public SequenceIterator begin(){
    return new SequenceIterator(element, subSeq, size, false);
  }
  public SequenceIterator end(){
    return new SequenceIterator(element, subSeq, size, true);
  }
  ...
  public Sequence(Element ele, Sequence se, int siz){
    element = ele;
    subSeq = se;
    size = siz;
  }
